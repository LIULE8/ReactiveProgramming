...
public class CustomerController {
  ...
  @Autowired private CustomerTicketService customerTicketService;

  @PostMapping(value = "/{accountId}/{orderNumber}")
  public Mono<CustomerTicket> generateCustomerTicket(
      @PathVariable("accountId") String accountId,
      @PathVariable("orderNumber") String orderNumber) {

    Mono<CustomerTicket> customerTicket =
        customerTicketService.generateCustomerTicket(accountId, orderNumber);
